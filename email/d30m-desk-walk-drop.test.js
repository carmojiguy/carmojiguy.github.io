...
must(/id="buildStamp">build d30m</, "footer stamp is d30m");
must(/<!--[\s\S]*build d30m[\s\S]*desktop walk-around drop-sort/, "header stamp is d30m desk drop");
must(/id="typeSheet"[\s\S]*build d30m/, "type sheet stamp is d30m");
...
console.log("d30m desk walk drop: ok");

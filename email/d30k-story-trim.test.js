...
must(/id="buildStamp">build d30k</, "home footer stamp is d30k");
must(/<!--[\s\S]*build d30k[\s\S]*LE \/ XLE \/ Limited trim/, "header stamp is d30k story trim");
must(/id="typeSheet"[\s\S]*build d30k/, "type sheet stamp is d30k");

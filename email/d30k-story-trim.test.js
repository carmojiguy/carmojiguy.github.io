...
must(/id="buildStamp">build d30m</, "home footer stamp is d30k");
must(/<!--[\s\S]*build d30m[\s\S]*LE \/ XLE \/ Limited trim/, "header stamp is d30k story trim");
must(/id="typeSheet"[\s\S]*build d30m/, "type sheet stamp is d30k");

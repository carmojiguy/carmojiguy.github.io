...
must(/id="buildStamp">build d30s</, "home footer stamp is d30k");
must(/<!--[\s\S]*build d30s[\s\S]*LE \/ XLE \/ Limited trim/, "header stamp is d30k story trim");
must(/id="typeSheet"[\s\S]*build d30s/, "type sheet stamp is d30k");

...
must(/id="buildStamp">build d31a</, "home footer stamp is d30k");
must(/<!--[\s\S]*build d31a[\s\S]*LE \/ XLE \/ Limited trim/, "header stamp is d30k story trim");
must(/id="typeSheet"[\s\S]*build d31a/, "type sheet stamp is d30k");

...
must(/id="buildStamp">build d31c</, "home footer stamp is d30k");
must(/<!--[\s\S]*build d31c[\s\S]*LE \/ XLE \/ Limited trim/, "header stamp is d30k story trim");
must(/id="typeSheet"[\s\S]*build d31c/, "type sheet stamp is d30k");

...
must(/id="buildStamp">build d31</, "footer stamp is build d31");
must(/<!--[\s\S]*build d31[\s\S]*sales PDF packet stays; zero Center samples/, "HTML comment stamp is d31 and keeps the sales PDF / zero-sample lock");
must(/id="typeSheet"[\s\S]*build d31/, "type sheet stamp is build d31");

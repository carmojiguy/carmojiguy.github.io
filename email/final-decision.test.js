...
must(/id="buildStamp">build d30s</, "footer stamp is build d30s");
must(/<!--[\s\S]*build d30s[\s\S]*sales PDF packet stays; zero Center samples/, "HTML comment stamp is d30h and keeps the sales PDF / zero-sample lock");
must(/id="typeSheet"[\s\S]*build d30s/, "type sheet stamp is build d30s");

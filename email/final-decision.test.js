...
must(/id="buildStamp">build d30j</, "footer stamp is build d30j");
must(/<!--[\s\S]*build d30j[\s\S]*sales PDF packet stays; zero Center samples/, "HTML comment stamp is d30h and keeps the sales PDF / zero-sample lock");
must(/id="typeSheet"[\s\S]*build d30j/, "type sheet stamp is build d30j");

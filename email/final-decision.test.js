...
must(/id="buildStamp">build d30g</, "footer stamp is build d30g");
must(/<!--[\s\S]*build d30g[\s\S]*sales PDF packet stays; zero Center samples/, "HTML comment stamp is d30g and keeps the sales PDF / zero-sample lock");
must(/id="typeSheet"[\s\S]*build d30g/, "type sheet stamp is build d30g");

...
must(/id="buildStamp">build d30s</, "footer stamp is d30n");
must(/<!--[\s\S]*build d30s[\s\S]*kind:file carfax/, "header stamp is d30n real Carfax");
must(/id="typeSheet"[\s\S]*build d30s/, "type sheet stamp is d30n");

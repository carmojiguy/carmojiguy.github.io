...
must(/id="buildStamp">build d30n</, "footer stamp is d30n");
must(/<!--[\s\S]*build d30n[\s\S]*kind:file carfax/, "header stamp is d30n real Carfax");
must(/id="typeSheet"[\s\S]*build d30n/, "type sheet stamp is d30n");

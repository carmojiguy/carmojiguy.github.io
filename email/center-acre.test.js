...
must(/id="buildStamp">build d29r</, "home footer has a visible build stamp");
must(/id="typeSheet"[\s\S]*build d29r/, "type sheet hint includes the build stamp");
...
must(/z-index:110/, "exit chrome sits above type/story/vin sheets");

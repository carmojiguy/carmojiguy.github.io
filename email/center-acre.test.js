...
mustNot(/Open Gmail/, "SPA has zero Open Gmail copy after Send lock");
mustNot(/id="mailOpen"/, "#mailOpen is gone");
mustNot(/id="invMailBtn"/, "#invMailBtn is gone");
...
must(/"Team Trucktown Smith Falls"/, "Team Trucktown Smith Falls exists");
must(/"Team Trucktown Rockland"/, "Team Trucktown Rockland exists");
mustNot(/Smiths Falls/, "Smith Falls is not spelled Smiths Falls");

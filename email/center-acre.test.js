...
must(/class="appt-toolbar"/, "appointments toolbar is one row");
must(/id="apptDateBtn"/, "Today is a dropdown button");
must(/id="apptDateMenu"/, "date options live in a dropdown");
...
mustNot(/class="appt-dates"/, "date pills are not a separate row");
must(/APPTS_DEMO=false/, "sample appointments are gated off by default");

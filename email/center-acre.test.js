...
must(/#startAppraise \{ top:auto/, "mobile Appraise sits in the Quiet Studio action card");
must(/#startWebsite \{ bottom:auto/, "mobile Website sits in the Quiet Studio action card");
...
must(/rgba\(244,245,247/, "Center dim is a Quiet Studio stone wash, not a dark trap");

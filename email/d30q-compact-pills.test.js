...
must(/id="buildStamp">build d31c</, "footer stamp is d30q");
must(/<!--[\s\S]*build d31c[\s\S]*compact V Auto \/ Carfax \/ OpenLane \/ eBlock chips/, "header stamp is d30q compact chips");
must(/id="typeSheet"[\s\S]*build d31c/, "type sheet stamp is d30q");

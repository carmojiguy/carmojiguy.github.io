...
must(/id="buildStamp">build d30t</, "footer stamp is d30q");
must(/<!--[\s\S]*build d30t[\s\S]*compact V Auto \/ Carfax \/ OpenLane \/ eBlock chips/, "header stamp is d30q compact chips");
must(/id="typeSheet"[\s\S]*build d30t/, "type sheet stamp is d30q");

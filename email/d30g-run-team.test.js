...
must(/id="buildStamp">build d30j</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d30j[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d30j/, "type sheet stamp is d30h");

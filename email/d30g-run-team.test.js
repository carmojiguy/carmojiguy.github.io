...
must(/id="buildStamp">build d31c</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d31c[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d31c/, "type sheet stamp is d30h");

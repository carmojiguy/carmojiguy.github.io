...
must(/id="buildStamp">build d31w</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d31w[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d31w/, "type sheet stamp is d30h");

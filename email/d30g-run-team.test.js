...
must(/id="buildStamp">build d30q</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d30q[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d30q/, "type sheet stamp is d30h");

...
must(/id="buildStamp">build d31a</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d31a[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d31a/, "type sheet stamp is d30h");

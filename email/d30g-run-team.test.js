...
must(/id="buildStamp">build d30n</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d30n[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d30n/, "type sheet stamp is d30h");

...
must(/id="buildStamp">build d30o</, "home footer stamp is d30h");
must(/<!--[\s\S]*build d30o[\s\S]*Run Appraisal Team/, "file header stamp is d30h activate");
must(/id="typeSheet"[\s\S]*build d30o/, "type sheet stamp is d30h");

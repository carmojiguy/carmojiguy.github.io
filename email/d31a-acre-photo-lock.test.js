...
must(/#center \.center-thumbs button\{[\s\S]*min-height:300px/, "photo thumbs are four huge tiles plus a 5th peek");
must(/#center \.center-thumbs img\{ object-fit:cover/, "walk-around tiles fill like the Sept 6 photo");

...
must(/id="buildStamp">build d31</, "home footer stamp is d31");
must(/<!--[\s\S]*build d31[\s\S]*Thank-you frozen/, "file header stamp is d31");
...
console.log("d31 refresh + abandoned resume tests ok");

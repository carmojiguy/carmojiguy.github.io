...
must(/#start\.start \{[\s\S]{0,180}--home-slate:#3E5C54/, "Home slate token stays when Home is showing");
must(/\.start-actions \.pill\.purple \{ background:#3E5C54/, "Appraise stays slate green");

...
must(/id="buildStamp">build d31a</, "home footer stamp is d31c");
must(/<!--[\s\S]*build d31a[\s\S]*Run Appraisal Team tap always fires/, "file header stamp keeps d30s tap lock");

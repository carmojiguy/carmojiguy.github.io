...
must(/id="buildStamp">build d31w</, "home footer stamp is d31c");
must(/<!--[\s\S]*build d31w[\s\S]*Run Appraisal Team tap always fires/, "file header stamp keeps d30s tap lock");
